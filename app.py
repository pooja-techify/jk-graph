...
def visualize(text):
    ...
    So each data entry when graph_type is 'piechart' would be as follows:
        'datakey_Pie_1: numerical_value, namekey_Pie_1: categorical_value'
        This is only an example on the order to be followed and the actual data key and value would vary.
